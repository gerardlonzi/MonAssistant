export const cvData =  {
    ...
    compétences:[
        ...
        "Bonne communication avec les clients ou équipes pour comprendre les besoins",
        "Bases en communication web : SEO,design UX/UI, intégration de sites"
    ],
    languages :[
        "Français (courant)",
        "Anglais (courant)"
    ...
    profile:" Développeur web expérimenté avec plus de 2 ans d’expérience dans la conception, le développement et la maintenance de solutions web performantes et à créer des interfaces modernes et efficaces. Habitué à collaborer avec des parties prenantes pour transformer des besoins métiersen solutions digitales concrètes et évolutives."
    ,
    experience:[
      {

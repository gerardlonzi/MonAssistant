  ...
  return (
    ...
    <Container className='mt-24 sm:mt-40'>
      <section className='mt-20 text-[#00275b]'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-5 sm:gap-16 mb-3 sm:mb-10 text-center relative'>
          <div className='flex flex-col items-center justify-center'>
            <div className='flex items-center relative h-28 sm:h-44 w-28 sm:w-44 bg-[#f0fff5]'>
              <img className='p-5  rounded-lg w-full' src="/svgs/rbd-hiw-template-icon.svg" alt="cHOISIR_UN_MODELES" />
            ...
            <p className='text-xl mt-4 sm:mt-10'>Choisissez votre modèle conçu <br/> par des professionnels</p>
          </div>
          <div className='flex flex-col items-center justify-center'>
            <div className='flex items-center relative h-28 sm:h-44 w-28 sm:w-44 bg-[#f0fff5]'>
              <img className='p-5  rounded-lg w-full' src="/svgs/rbd-hiw-example-icon.svg" alt="AJOUTER_UN_MODELE_PRECIS" />
            ...
            <p className='text-xl mt-4 sm:mt-10'>Ajoutez des exemples pré-écrits <br/> à chaque section</p>
          </div>
          <div className='flex flex-col items-center justify-center'>
            <div className='flex items-center relative h-28 sm:h-44 w-28 sm:w-44 bg-[#f0fff5]'>
              <img className='p-5  rounded-lg w-full' src="/svgs/rbd-hiw-download-icon.svg" alt="telecharger_et_postuler_icon" />
            ...
            <p className='text-xl mt-4 sm:mt-10'>Téléchargez et commencez <br/> à postuler</p>
          </div>
          <div className='text-xl text-black rounded-full flex flex-col sm:flex-row hidden sm:flex gap-3 absolute -z-10 top-[75px]'>
            <span>•</span>
            <span>•</span>
            <span>•</span>
            <span>•</span>
